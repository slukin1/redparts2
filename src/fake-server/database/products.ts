...
function makeProducts(defs: IProductDef[]): IProduct[] {
    return defs.map((def) => {
        ...
        return {
            ...
            name: def.name,
            excerpt: `
               NOTICE: Please contact us for detail informations about total cost and shipping.
            `,
            description: `
                <p>
                </p>
                <h4>NOTICE</h4>
                <p>
                    If you do not find your favourite car from our stock list, don't hesitate to send us your car requirements via the link below, we can recommend you some options.
                </p>
            `,
            slug: def.slug,
            sku: def.sku,
