...
// application
import { brands } from '~/routes/database/brands';
import { IBrand } from '~/interfaces/brand';
import { IProduct, IProductAttribute } from '~/interfaces/product';
import { IShopCategory } from '~/interfaces/category';
import { makeIdGenerator, nameToSlug } from '~/routes/utils';
import { prepareCategory } from '~/routes/endpoints/categories';
import { IProductAttributesDef, IProductDef } from '~/routes/interfaces/product-def';
