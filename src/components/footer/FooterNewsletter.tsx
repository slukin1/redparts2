...
const FooterNewsletter: FunctionComponent<React.HTMLAttributes<HTMLElement>> = () => {
    ...
    const socialLinks = [
        ...
        { type: 'twitter', url: theme.twitter_url, icon: 'fab fa-twitter' },
        { type: 'youtube', url: theme.youtube_url, icon: 'fab fa-youtube' },
        { type: 'instagram', url: theme.instagram_url, icon: 'fab fa-instagram' },
    ];
