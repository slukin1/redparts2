// application
import { ICategoryDef } from '~/api/routes/interfaces/category-def';
...
const shopCategoriesDef: ICategoryDef[] = [
    ...
    },
    {
        ...
        items: 356,
        children: [
            { name: 'under $1,000', slug: JSON.stringify({ filter_price: '0-129870' }) },
            { name: '$1,000 ~ $2,000', slug: JSON.stringify({ filter_price: `${129870}-${2 * 129870}` }) },
            { name: '$2,000 ~ $3,000', slug: JSON.stringify({ filter_price: `${2 * 129870}-${3 * 129870}` }) },
            { name: '$3,000 ~ $4,000', slug: JSON.stringify({ filter_price: `${3 * 129870}-${4 * 129870}` }) },
            { name: '$4,000 ~ $5,000', slug: JSON.stringify({ filter_price: `${4 * 129870}-${5 * 129870 + 1}` }) },
            { name: '$5,000 ~ $6,000', slug: JSON.stringify({ filter_price: `${5 * 129870 + 1}-${6 * 129870 + 1}` }) },
            { name: 'Over $6,000', slug: JSON.stringify({ filter_price: `${6 * 129870 + 1}-40000000` }) },
        ],
    },
    {
        name: 'Body Type',
    ...
    },
    {
        ...
        children: [
            ...
            { name: '100000 - 150000km', slug: JSON.stringify({ filter_mileage: '100000-150000' }) },
